...
object Jsons {
  ...
  object SelfEmployment {
    ...
    def period(fromDate: Option[String] = None,
               ...
               turnover: BigDecimal = 0,
               otherIncome: BigDecimal = 0,
               costOfGoodsBought: BigDecimal = 0,
               cisPaymentsToSubcontractors: BigDecimal = 0,
               staffCosts: BigDecimal = 0,
               travelCosts: BigDecimal = 0,
               premisesRunningCosts: BigDecimal = 0,
               maintenanceCosts: BigDecimal = 0,
               adminCosts: BigDecimal = 0,
               advertisingCosts: BigDecimal = 0,
               interest: BigDecimal = 0,
               financialCharges: BigDecimal = 0,
               badDebt: BigDecimal = 0,
               professionalFees: BigDecimal = 0,
               depreciation: BigDecimal = 0,
               otherExpenses: BigDecimal = 0,
